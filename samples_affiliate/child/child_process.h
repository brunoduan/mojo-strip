...
#ifndef SAMPLES_CHILD_CHILD_PROCESS_H_
#define SAMPLES_CHILD_CHILD_PROCESS_H_
...
// Base class for child processes of the master process (i.e. renderer and
...
class SAMPLES_EXPORT ChildProcess {
 public:
  ...
  // waiting for some information from the master process.  If the master
  ...
  //
  // This is not used for renderer processes. The master process is the only
...
#endif  // SAMPLES_CHILD_CHILD_PROCESS_H_
