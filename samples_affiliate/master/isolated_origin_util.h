...
#ifndef SAMPLES_MASTER_ISOLATED_ORIGIN_UTIL_H_
#define SAMPLES_MASTER_ISOLATED_ORIGIN_UTIL_H_
...
class SAMPLES_EXPORT IsolatedOriginUtil {
 public:
...
#endif  // SAMPLES_MASTER_ISOLATED_ORIGIN_UTIL_H_
