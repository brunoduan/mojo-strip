...
#ifndef SAMPLES_MASTER_CHILD_PROCESS_LAUNCHER_H_
#define SAMPLES_MASTER_CHILD_PROCESS_LAUNCHER_H_
...
struct ChildProcessLauncherPriority {
  ...
  // foreground samples which hasn't yet been added as a visible widget -- i.e.
  // during navigation).
...
class SAMPLES_EXPORT ChildProcessLauncher {
 public:
  class SAMPLES_EXPORT Client {
   public:
 ...
 private:
  ...
  Client* client_;
  MasterThread::ID client_thread_id_;
  ...
  // Controls whether the child process should be terminated on master
...
#endif  // SAMPLES_MASTER_CHILD_PROCESS_LAUNCHER_H_
