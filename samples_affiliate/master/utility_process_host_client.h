...
#ifndef SAMPLES_MASTER_UTILITY_PROCESS_HOST_CLIENT_H_
#define SAMPLES_MASTER_UTILITY_PROCESS_HOST_CLIENT_H_
...
#endif  // SAMPLES_MASTER_UTILITY_PROCESS_HOST_CLIENT_H_
