...
#ifndef SAMPLES_MASTER_TRACING_BACKGROUND_TRACING_MANAGER_IMPL_H_
#define SAMPLES_MASTER_TRACING_BACKGROUND_TRACING_MANAGER_IMPL_H_
...
#include "samples/public/master/background_tracing_manager.h"
...
class BackgroundTracingManagerImpl : public BackgroundTracingManager {
 public:
  ...
  // changes.
  class SAMPLES_EXPORT EnabledStateObserver {
   public:
  ...
  SAMPLES_EXPORT static BackgroundTracingManagerImpl* GetInstance();
  ...
  SAMPLES_EXPORT void AddEnabledStateObserver(EnabledStateObserver* observer);
  SAMPLES_EXPORT void RemoveEnabledStateObserver(
  ...
  SAMPLES_EXPORT void SetRuleTriggeredCallbackForTesting(
      const base::Closure& callback);
  void FireTimerForTesting() override;
  SAMPLES_EXPORT bool IsTracingForTesting();
  SAMPLES_EXPORT bool requires_anonymized_data_for_testing() const {
 ...
 private:
  ...
  std::unique_ptr<const samples::BackgroundTracingConfigImpl> config_;
...
#endif  // SAMPLES_MASTER_TRACING_BACKGROUND_TRACING_MANAGER_IMPL_H_
