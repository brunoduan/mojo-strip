...
#ifndef SAMPLES_PUBLIC_MASTER_CHILD_PROCESS_SECURITY_POLICY_H_
#define SAMPLES_PUBLIC_MASTER_CHILD_PROCESS_SECURITY_POLICY_H_
...
// has ever been commanded to load file:// URLs by the master.
//
...
class ChildProcessSecurityPolicy {
 public:
  ...
  // master process.  The object returned by this method may be accessed on
  // any thread.
  static SAMPLES_EXPORT ChildProcessSecurityPolicy* GetInstance();
  ...
  // IsolatedWorldSecurityOrigin mechanism, as for extension samples scripts.
  ...
  // master should call this function to grant the child process the capability
  ...
  // Before servicing a child process's request for a URL, the samples layer
  ...
  // master should call this method to determine whether the process has the
  ...
  // origin. Usage should be extremely rare: the samples framework already
  ...
  // policy, or by a samples/ embedder using
...
#endif  // SAMPLES_PUBLIC_MASTER_CHILD_PROCESS_SECURITY_POLICY_H_
