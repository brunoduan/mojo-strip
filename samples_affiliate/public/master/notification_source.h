...
#ifndef SAMPLES_PUBLIC_MASTER_NOTIFICATION_SOURCE_H_
#define SAMPLES_PUBLIC_MASTER_NOTIFICATION_SOURCE_H_
...
class SAMPLES_EXPORT NotificationSource {
 public:
...
#endif  // SAMPLES_PUBLIC_MASTER_NOTIFICATION_SOURCE_H_
