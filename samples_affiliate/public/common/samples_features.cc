...
// Enables samples-initiated, main frame navigations to data URLs.
...
// Enables the compositing of fixed position samples that is opaque and can
// preserve LCD text.
const base::Feature kCompositeOpaqueFixedPosition{
    "CompositeOpaqueFixedPosition", base::FEATURE_DISABLED_BY_DEFAULT};

// Enables the compositing of scrolling samples that supports painting the
...
// Kill switch for Web Notification samples images.
