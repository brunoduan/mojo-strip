...
const char kDisableNewContentRenderingTimeout[] =
    "disable-new-samples-rendering-timeout";
...
// Disable multithreaded GPU compositing of web samples.
const char kDisableThreadedCompositing[]     = "disable-threaded-compositing";

// Disable multithreaded, compositor scrolling of web samples.
...
const char kEnableStrictMixedContentChecking[] =
    "enable-strict-mixed-samples-checking";
...
// For development / testing only. When running samples_browsertests,
// saves output of failing accessibility tests to their expectations files in
// samples/test/data/accessibility/, overwriting existing file samples.
...
// Don't allow samples to arbitrarily append to the back/forward list.
...
// sampless on various embedded devices and changeable network bandwidths in
...
// Number of worker threads used to rasterize samples.
...
// The value of this switch determines the package name which the process
// is associated with.
const char kPackageName[]                   = "pkg-name";
...
// The sampless of this flag are prepended to the utility process command line.
// Useful values might be "valgrind" or "xterm -e gdb --args".
...
// Disable the pull-to-refresh effect when vertically overscrolling samples.
...
// /prefetch:5, /prefetch:6 and /prefetch:7 are reserved for samples embedders
// and are not to be used by samples itself.
