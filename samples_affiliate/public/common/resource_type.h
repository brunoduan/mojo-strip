...
#ifndef SAMPLES_PUBLIC_COMMON_RESOURCE_TYPE_H_
#define SAMPLES_PUBLIC_COMMON_RESOURCE_TYPE_H_
...
SAMPLES_EXPORT bool IsResourceTypeFrame(ResourceType type);

}  // namespace samples

#endif  // SAMPLES_PUBLIC_COMMON_RESOURCE_TYPE_H_
