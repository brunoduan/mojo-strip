...
#include "samples/common/child.mojom.h"
...
class ServiceManagerConnectionImpl::IOThreadContext
 ...
 private:
  ...
  void OnBindInterface(const service_manager::BindSourceInfo& source_info,
    ...
    } else if (source_info.identity.name() == mojom::kMasterServiceName &&
...
void ServiceManagerConnection::SetForProcess(
  ...
  Java_ServiceManagerConnectionImpl_notifyConnectionReady(env);
}
