...
//                   the result file after shutting the master down.
//
...
//                   2) or after master shutdown if startup duration is 0.
...
// all Chrome based masters read customized flag, e.g., Android WebView. Chrome
...
class TRACING_EXPORT TraceStartupConfig {
 public:
  ...
  static base::trace_event::TraceConfig GetDefaultMasterStartupConfig();
