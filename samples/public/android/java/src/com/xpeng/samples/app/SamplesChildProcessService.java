...
/**
 * Implementation of ChildProcessService that uses the samples specific delegate.
 ...
 */
public class SamplesChildProcessService extends ChildProcessService {
    public SamplesChildProcessService() {
        super(new SamplesChildProcessServiceDelegate());
    }
}
