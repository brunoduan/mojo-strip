 ...
 */
public interface SamplesChildProcessConstants {
    ...
    public static final String EXTRA_CPU_COUNT = "com.google.android.apps.samples.extra.cpu_count";

    // Key for the CPU features mask.
    public static final String EXTRA_CPU_FEATURES =
            "com.google.android.apps.samples.extra.cpu_features";
}
