...
import com.xpeng.samples.common.ui.widget.Toast;
 ...
 * <ul>
 * <li>To start tracing: am broadcast -a com.xpeng.samples_shell_apk.GPU_PROFILER_START
 * <li>Add "-e file /foo/bar/xyzzy" to log trace data to a specific file.
 * <li>To stop tracing: am broadcast -a com.xpeng.samples_shell_apk.GPU_PROFILER_STOP
 * </ul>
...
public class TracingControllerAndroid {
    ...
    public boolean startTracing(boolean showToasts, String categories, String traceOptions) {
        ...
        if (filePath == null) {
            logAndToastError("Can\'t start profiler because external storage is not ready");
        }
     ...
     * (in samples/public/master/trace_controller.h) for the format.
    ...
    public boolean startTracing(String filename, boolean showToasts, String categories,
        ...
        if (!nativeStartTracing(mNativeTracingControllerAndroid, categories,
            ...
            logAndToastError("Failed to start profiler");
            return false;
        }

        logForProfiler(String.format(PROFILER_STARTED_FMT, categories));
        showToast("Profiler started" + ": " + categories);
        mFilename = filename;
        mIsTracing = true;
        return true;
    }
    ...
    protected void onTracingStopped() {
        ...
        showToast("Profiler finished. Results are in " + mFilename);
        mIsTracing = false;
        mFilename = null;
    }
