...
#ifndef SAMPLES_PUBLIC_MASTER_NOTIFICATION_DETAILS_H_
#define SAMPLES_PUBLIC_MASTER_NOTIFICATION_DETAILS_H_
...
class SAMPLES_EXPORT NotificationDetails {
 public:
...
#endif  // SAMPLES_PUBLIC_MASTER_NOTIFICATION_DETAILS_H_
