...
#ifndef SAMPLES_PUBLIC_COMMON_SANDBOX_INIT_H_
#define SAMPLES_PUBLIC_COMMON_SANDBOX_INIT_H_
...
// Initialize the sandbox of the given |sandbox_type|. Although The master
...
// returned.
SAMPLES_EXPORT bool InitializeSandbox(
...
// the handles.
SAMPLES_EXPORT sandbox::ResultCode StartSandboxedProcess(
...
// processes, depending on the command line flags. For the master process which
...
SAMPLES_EXPORT bool InitializeSandbox(base::OnceClosure post_warmup_hook);
...
SAMPLES_EXPORT std::unique_ptr<sandbox::bpf_dsl::Policy>
GetBPFSandboxBaselinePolicy();
#endif  // defined(OS_LINUX) || defined(OS_NACL_NONSFI)

}  // namespace samples

#endif  // SAMPLES_PUBLIC_COMMON_SANDBOX_INIT_H_
