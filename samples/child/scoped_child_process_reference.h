...
#ifndef SAMPLES_CHILD_SCOPED_CHILD_PROCESS_REFERENCE_H_
#define SAMPLES_CHILD_SCOPED_CHILD_PROCESS_REFERENCE_H_
...
#endif  // SAMPLES_CHILD_SCOPED_CHILD_PROCESS_REFERENCE_H_
