...
#ifndef SAMPLES_MASTER_NOTIFICATION_SERVICE_IMPL_H_
#define SAMPLES_MASTER_NOTIFICATION_SERVICE_IMPL_H_
...
class SAMPLES_EXPORT NotificationServiceImpl : public NotificationService {
 public:
...
#endif  // SAMPLES_MASTER_NOTIFICATION_SERVICE_IMPL_H_
