...
#ifndef SAMPLES_MASTER_UTILITY_PROCESS_HOST_H_
#define SAMPLES_MASTER_UTILITY_PROCESS_HOST_H_
...
// This class acts as the master-side host to a utility child process.  A
...
class SAMPLES_EXPORT UtilityProcessHost
    : public IPC::Sender,
      public MasterChildProcessHostDelegate {
 public:
 ...
 private:
  ...
  std::unique_ptr<MasterChildProcessHostImpl> process_;
...
#endif  // SAMPLES_MASTER_UTILITY_PROCESS_HOST_H_
