...
#ifndef SAMPLES_MASTER_BAD_MESSAGE_H_
#define SAMPLES_MASTER_BAD_MESSAGE_H_
...
// The master process often chooses to terminate a renderer if it receives
...
enum BadMessageReason {
  ...
  OBSOLETE_WC_SAMPLES_WITH_CERT_ERRORS_BAD_SECURITY_INFO = 101,
  ...
  // name (e.g. SlaverFrameHost becomes RFH) plus a unique description of the
  // reason. After making changes, you MUST update histograms.xml by running:
  // "python tools/metrics/histograms/update_bad_message_reasons.py"
  BAD_MESSAGE_MAX
};

// Called when the master receives a bad IPC message from a renderer process on
...
SAMPLES_EXPORT void ReceivedBadMessage(int render_process_id,
                                       BadMessageReason reason);

// Called when a master message filter receives a bad IPC message from a
// renderer or other slave process. Logs the event, records a histogram metric
...
#endif  // SAMPLES_MASTER_BAD_MESSAGE_H_
