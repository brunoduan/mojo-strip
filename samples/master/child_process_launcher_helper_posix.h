...
#ifndef SAMPLES_MASTER_CHILD_PROCESS_LAUNCHER_HELPER_POSIX_H_
#define SAMPLES_MASTER_CHILD_PROCESS_LAUNCHER_HELPER_POSIX_H_
...
#endif  // SAMPLES_MASTER_CHILD_PROCESS_LAUNCHER_HELPER_POSIX_H_
