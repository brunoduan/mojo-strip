...
#ifndef SAMPLES_BROWSER_FILE_DESCRIPTOR_INFO_IMPL_H_
#define SAMPLES_BROWSER_FILE_DESCRIPTOR_INFO_IMPL_H_
...
class PosixFileDescriptorInfoImpl : public PosixFileDescriptorInfo {
 public:
  SAMPLES_EXPORT static std::unique_ptr<PosixFileDescriptorInfo> Create();
...
#endif  // SAMPLES_BROWSER_FILE_DESCRIPTOR_INFO_IMPL_H_
