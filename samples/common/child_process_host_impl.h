...
#ifndef SAMPLES_COMMON_CHILD_PROCESS_HOST_IMPL_H_
#define SAMPLES_COMMON_CHILD_PROCESS_HOST_IMPL_H_
...
class SAMPLES_EXPORT ChildProcessHostImpl : public ChildProcessHost,
                                            public IPC::Listener {
 public:
...
#endif  // SAMPLES_COMMON_CHILD_PROCESS_HOST_IMPL_H_
