...
#ifndef SAMPLES_COMMON_SERVICE_MANAGER_CHILD_CONNECTION_H_
#define SAMPLES_COMMON_SERVICE_MANAGER_CHILD_CONNECTION_H_
...
class SAMPLES_EXPORT ChildConnection {
 public:
...
#endif  // SAMPLES_COMMON_SERVICE_MANAGER_CHILD_CONNECTION_H_
